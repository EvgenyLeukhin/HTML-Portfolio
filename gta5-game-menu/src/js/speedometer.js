...
$.fn.myfunc = function (userPref) {
  ...
  this.defaultProperty = {
    // маштабирование спидометра
    // по умолчанию
    // maxVal              : 200,         /**Max value of the meter*/
    divFact             : 10,          /**Division value of the meter*/
    // dangerLevel         : 160,         /**more than this leval, color will be red*/
    ...
    // маштабирование
    edgeRadius          : 120,        // основной круг
    indicatorRadius     : 100,        // риски
    speedPositionTxtWH  : 60,         // внутренний круг
    indicatorNumbRadius : 70,         // цифры

    // маштабирование рисок
    ...
    numbW               : 30,          /**indicator number width*/
    numbH               : 25,          /**indicator number height*/
  ...
  this.changePosition = function (){
    // вывести значение скорости в консоль
